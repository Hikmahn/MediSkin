			...
			<div class="topnav" id="myTopnav">
				<nav class="main_nav" style="color: black    ">
					...
					<li ><div class="Registrasi">
						<button onclick="myFunction()" class="dropbtn" style="font-size: 15px;font-weight: 600;">
						Registrasi</button>
							<div id="myDropdown" class="dropdown-content" style="color: #57ccc3">
								<a href="registrasi Customer.php">Register Customer</a>
								<a href="registrasi_clinic.php">Register Clinic</a>
							</div>
						</div>
					</li>
...
<li ><div class="Login">
							...
							<div id="Dropdown" class="dropdown-content2" style="color: #57ccc3">
								...
								<a href="reg_clinic.html">Login Clinic</a>
...
<li><a href="appointment.php">Jadwal Dokter</a></li>
<li><a href="appointment.php">Klinik</a></li>
</ul>
</nav>	
