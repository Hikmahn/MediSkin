			...
			<div class="topnav" id="myTopnav">
				<nav class="main_nav" style="color: black    ">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						...
						<li><a href="registrasi_clinic.php">Register</a></li>
							<li ><div class="Login">
...
<li><a href="datadokter.php">Doctor</a></li>
  ...
  <div class="year year--end">
	...
	<div class="footer_content"  style="background-image: url(images/qq3.jpg); background-size: 100%"  >
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h1 style="text-align: center; color: white; font-family: times rowman;color: black;">Who Join with Us</h1>
					
				</div>
				<!-- Footer Erha -->
				<div class="col-lg-3 footer_col">
					<div class="footer_contact">
						<div class="footer_title" style="text-align: center;color: black;">Erha Klinik</div><hr>
						<div class="flip-card">
				...
				<div class="col-lg-3 footer_col">
					<div class="footer_contact">
						<div class="footer_title" style="text-align: center;color: black;">Airin Klinik<hr></div>
						<div class="flip-card">
							<div class="flip-card-inner">
								<div class="flip-card-front">
				...
				<div class="col-lg-3 footer_col">
					<div class="footer_contact">
						<div class="footer_title" style="text-align: center;color: black;">Natasha Klinik</div><hr>
						<div class="flip-card">
							<div class="flip-card-inner">
								<div class="flip-card-front">
				...
				<div class="col-lg-3 footer_col">
					<div class="footer_contact">
						...
						<div class="footer_title" style="text-align: center;color: black;">Carissa Klinik<hr>
					</div>
						<div class="flip-card">
							<div class="flip-card-inner">
								<div class="flip-card-front">
